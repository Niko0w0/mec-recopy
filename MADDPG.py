...
max_grad_norm = 0.5
save_model = 40
save_dir = "models/simple_adversary/maddpg"
save_fer = 400
tao = 0.01
file_path = "res/maddpg_td_errors.json"

class Maddpg(object):
    
    def get_train(self, env, obs_shape_n, action_shape_n):
        
        # actors_cur = [None, None, None]
    ...
    def agents_train(self, game_step, update_cnt, memory, obs_size, action_size,
        ...
        if (game_step > learning_start_step) and (game_step % learning_fre == 0):
            ...
            for agent_idx, (actor_c, actor_t, critic_c, critic_t, opt_a, opt_c) in \
                ...
                # print("tar_value: ", tar_value)
                # print("q: ", q)
                # print("maddpg priorities: ", priorities)
                # print("maddpg td_errors:", td_errors)
                ...
                write.add_scalar("Loss/maddpg/Actor", loss_t, game_step)
                write.add_scalar("Loss/maddpg/Critic", loss_c, game_step)
